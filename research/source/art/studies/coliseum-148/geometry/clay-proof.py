...
R=Path('/PATH/TO/transmissions-from-alpha-centauri');O=R/'art/studies/coliseum-148/geometry'
for label,path in [('before',R/'art/studies/alley-weathering-147/actual/scene.blend'),('after',O/'scene.blend')]:
