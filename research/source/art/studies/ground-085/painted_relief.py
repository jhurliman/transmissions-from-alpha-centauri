...
for n in m.node_tree.nodes:
 if n.type=='MAP_RANGE' and abs(n.inputs['From Min'].default_value-.2)<.001 and abs(n.inputs['From Max'].default_value-.95)<.001:
  n.inputs['From Min'].default_value=.50;n.inputs['From Max'].default_value=.86;n.inputs['To Min'].default_value=.45;n.inputs['To Max'].default_value=1.55
