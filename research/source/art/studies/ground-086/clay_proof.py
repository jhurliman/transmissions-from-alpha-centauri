...
R=Path('/PATH/TO/transmissions-from-alpha-centauri');O=R/'art/studies/ground-086';bpy.ops.wm.open_mainfile(filepath=str(O/'scene.blend'));s=bpy.context.scene;s.render.threads_mode='FIXED';s.render.threads=4;s.render.use_freestyle=False;s.render.use_border=False
...
s.use_nodes=False;s.render.filepath=str(O/'clay-low-angle.png');bpy.ops.render.render(write_still=True)
