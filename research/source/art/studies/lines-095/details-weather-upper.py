...
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/soil-094/scene-C.blend'));s=bpy.context.scene;dep=bpy.context.evaluated_depsgraph_get();p=json.loads((R/'art/reviews/xenon-069/placements.json').read_text())[7]
...
bpy.ops.wm.save_as_mainfile(filepath=str(O/'details-weather-upper.blend'));print('WEATHER_READY',n,flush=True)
