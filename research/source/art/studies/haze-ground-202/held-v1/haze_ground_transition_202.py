...
def apply(scene):
 ...
 early=ramp(xyz.outputs['Y'],48,150,0,.82,'202 Broad ground source depth')
 ...
 return {'old_material':old.name,'new_material':m.name,'upper_haze_preserved_above_m':8.5,'low_source_depth_m':[48,150],'low_source_terminal_relative':.82,'low_scatter_max_multiplier':2,'nearest_city_start_m':48,'rear_cutoff_m':[205,225],'geometry_sky_lights_camera_unchanged':True}
