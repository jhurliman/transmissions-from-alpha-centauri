...
for name in names:
 ...
 if after['crossings']>before['crossings']or after['nonmanifold']or after['zero_faces']or after['components']!=before['components']or row['removed_volume_m3']<=0 or missing or row['missing_peak_anchor_vertices']:row['held']='Topology, volume or protected-face gate'
