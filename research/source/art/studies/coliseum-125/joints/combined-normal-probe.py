...
for mat in cache.values():
 for n in mat.node_tree.nodes:
  if n.type in ['BSDF_DIFFUSE','BSDF_GLOSSY'] and 'Normal' in n.inputs:n.inputs['Normal'].default_value=(0,-1,.04)
s.render.filepath=str(O/'combined-constant-normal-noink.png');bpy.ops.render.render(write_still=True)
