...
for side,y in [(-1,-3.80),(1,-3.80),(-1,13.0),(1,24.20)]:place('gangway_single_Y_8m',side,y)
...
for y in [.50,3.10]:box('Service bay portal jamb',(-9.05,y,2.12),(.30,.18,4.24),steel)
box('Service bay lintel',(-9.05,1.8,4.25),(.35,2.8,.28),pale)
...
q=instance('spool',Matrix.Translation((-8.00,5.50,14.2))@Matrix.Rotation(math.pi/2,4,'Z')@Matrix.Rotation(math.pi,4,'X'));bpy.context.view_layer.update();pk='spool'
