...
def window():
 ...
 for x0,x1 in [(-.74,-.024),(.024,.74)]:
  for z0,z1 in [(.23,1.0795),(1.1205,1.81)]:
   cx=(x0+x1)/2;cz=(z0+z1)/2;w=x1-x0;h=z1-z0
   box('Recessed infill pane',(cx,.355,cz),(w,.022,h),glass,.002)
   for x in [x0+.009,x1-.009]:box('Sash edge',(x,.325,cz),(.018,.032,h),steel)
   for z in [z0+.009,z1-.009]:box('Sash edge',(cx,.325,z),(w-.036,.032,.018),steel)
 box('Continuous central mullion',(0,.28,1.02),(.048,.065,1.58),edge)
 for x in [-.382,.382]:box('Transom meeting mullion',(x,.28,1.10),(.716,.065,.041),edge)
