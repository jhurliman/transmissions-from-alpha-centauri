...
b=signature(R/'art/reviews/xenon-050/hybrid.blend');a=signature(R/'art/reviews/xenon-051/scene.blend');assert a==b; (R/'art/reviews/xenon-051/preservation-audit.json').write_text(json.dumps({'matches_050_geometry_camera_visibility':True,'signature':a},indent=2));print('PASS preservation')
