...
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'));O=R/'art/studies/awning-runoff-251'
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/awning-runoff-251/scene.blend'));s=bpy.context.scene
