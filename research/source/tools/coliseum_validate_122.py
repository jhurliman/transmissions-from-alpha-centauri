...
after,am=snapshot(R/'art/studies/coliseum-122/scene.blend')
result={'baseline':'116','candidate':'122','nonlandmark_objects_compared':len(before),
...
(R/'art/studies/coliseum-122/preservation.json').write_text(json.dumps(result,indent=2))
...
bpy.data.libraries.write(str(R/'art/studies/coliseum-122/kit.blend'),{C},fake_user=True,compress=True)
