...
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'));O=R/'art/studies/awning-runoff-250'
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/awning-runoff-250/scene.blend'));s=bpy.context.scene
...
s.render.border_min_x=2400/3840;s.render.border_max_x=2840/3840;s.render.border_min_y=1-1200/2885;s.render.border_max_y=1-740/2885
