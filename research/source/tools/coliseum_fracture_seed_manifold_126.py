...
R=Path(__file__).resolve().parents[1];O=R/'art/studies/coliseum-126/fracture-seed-manifold';sys.path.insert(0,str(R/'tools'))
...
def run():
 ...
 text=text.replace("mod.solver='EXACT'","mod.solver='MANIFOLD'")
