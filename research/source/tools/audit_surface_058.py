...
b=signature(R/'art/reviews/xenon-057/scene.blend');c=signature(O/'scene.blend');assert b==c;(O/'preservation-audit.json').write_text(json.dumps({'baseline':b,'candidate':c,'identical':True},indent=2))
