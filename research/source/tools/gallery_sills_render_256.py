...
(D/'performance.json').write_text(json.dumps({'seconds':time.time()-t,'width':3840,'height':2885,'guards':[149,156,161,192,205,207,218]}));print('256 PROOF DONE',label,flush=True)
