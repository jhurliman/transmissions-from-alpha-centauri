...
R=Path(__file__).resolve().parents[1];O=R/'art/studies/coliseum-113';bpy.ops.wm.open_mainfile(filepath=str(O/'scene.blend'));s=bpy.context.scene;C=bpy.data.collections['110 Coliseum detailed front ruin']
