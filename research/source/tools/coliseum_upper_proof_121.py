...
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/coliseum-120/scene.blend'));s,C=isolate();dep=bpy.context.evaluated_depsgraph_get();points=[]
for ob in C.objects:
...
for label,path in [('baseline',R/'art/studies/coliseum-120/scene.blend'),('candidate',O/'scene.blend')]:
