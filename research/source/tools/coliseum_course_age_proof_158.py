"""Matched native component proof of the158 attached course-loss age composition."""
import bpy,sys,json,time,array,hashlib
from pathlib import Path
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'))
O=R/'art/studies/coliseum-158/material';O.mkdir(parents=True,exist_ok=True)
...
d['source']='156 material-only comparison;157 geometry paired proof remains a separate gate';d['crop']=[x0,y0,x1,y1]
