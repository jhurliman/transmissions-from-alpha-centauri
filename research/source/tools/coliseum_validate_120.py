...
after,am=snapshot(R/'art/studies/coliseum-120/scene.blend')
result={'baseline':'116','candidate':'120','nonlandmark_objects_compared':len(before),
...
(R/'art/studies/coliseum-120/preservation.json').write_text(json.dumps(result,indent=2))
