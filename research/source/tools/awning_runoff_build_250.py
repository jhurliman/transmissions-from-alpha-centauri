...
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'));O=R/'art/studies/awning-runoff-250';O.mkdir(exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/base-weather-249/scene.blend'));s=bpy.context.scene
from awning_runoff_250 import apply
