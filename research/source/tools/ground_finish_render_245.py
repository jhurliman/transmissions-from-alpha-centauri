...
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'));O=R/'art/studies/ground-finish-245'
label='245';D=O
...
(D/'performance.json').write_text(json.dumps({'seconds':time.time()-t,'width':3840,'height':2885,'guards':[149,156,161,192,205,207,218]}));print('245 PROOF DONE',label,flush=True)
