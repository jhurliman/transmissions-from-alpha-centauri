...
R=Path('/PATH/TO/transmissions-from-alpha-centauri');P=R/'prototype';a='/art/reviews/xenon-065/'
...
page=f'<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>065 · Crack depth darkening</title><style>{css}</style><header><h1>065 · Crack depth darkening</h1><p>All three retain the projected weathered finish and start 10% darker at the opening. B and C increase darkening with physical depth. A is a constant 10% control. Geometry, lighting, and narrow lip reflection are unchanged.</p><p><a href="#panel">Column</a> · <a href="#support">Support</a> · <a href="#alley">Alley camera</a> · <a href="review-064.html#panel">064 baseline</a></p></header>'
for part,title in [('panel','Column face'),('support','Concrete support'),('render','Alley camera')]:
 ...
 for label,description in [('A','10% → 10%'),('B','10% → 30%'),('C','10% → 60%')]:
...
(P/'review-065.html').write_text(page);(P/'index.html').write_text(page)
