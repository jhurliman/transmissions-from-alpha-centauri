"""Certify and remove only173 contact intervals losing solid support in185.

Run only after the185 source-shape gate. No threshold tuning or cosmetic erasure.
"""
...
O=R/'art/studies/coliseum-185/contact';O.mkdir(parents=True,exist_ok=True)
