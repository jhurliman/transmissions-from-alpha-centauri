...
def masonry(role='wall'):
 m=bpy.data.materials.new('114 Painted masonry '+role);m.use_nodes=True;n=m.node_tree.nodes;l=m.node_tree.links;n.clear()
 def node(t,label=''):
 ...
 colors=[(0,'16145f'),(.28,'322963'),(.46,'59455c'),(.58,'8d6b58'),(.80,'ab8165'),(1,'bd9875')]
