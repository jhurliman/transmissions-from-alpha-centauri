"""Append159kit into an empty native scene; full main camera plus bay/tower/crown/flat-wall proofs."""
...
regions={'full-main-camera':(0,0,3840,2885),'secondary-failure':(2025,535,2350,875),'repaired-return':(2020,440,2190,650)}
...
(O/'performance.json').write_text(json.dumps({'six_proof_render_seconds':time.time()-t,'native_frame_resolution':resolution,'regions':regions},indent=2))
