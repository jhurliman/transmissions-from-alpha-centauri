"""Hash-pinned incremental native166 recipe from the retained163 scene."""
from pathlib import Path
import hashlib,json
R=Path(__file__).resolve().parents[1];O=R/'art/studies/coliseum-166'
INPUTS={
 'historical_native_inputs':['art/studies/coliseum-163/scene.blend','art/studies/coliseum-163/delivery-manifest.json'],
 'build_code':['tools/coliseum_integration_166.py','tools/coliseum_core_response_165.py','tools/scene_integration_138.py','tools/coliseum_ink_regression_149.py','tools/coliseum_foreground_visibility_156.py','tools/coliseum_foreground_visibility_161.py'],
 'configuration':['config/coliseum-core-response-165.json'],
 'delivery_code':['tools/coliseum_delivery_audit_166.py','tools/coliseum_kit_proof_166.py','tools/coliseum_validate_166.py','tools/publish_coliseum_166.py','tools/coliseum_delivery_manifest_166.py']}
...
out={
 'scope':'Incremental native166 build from retained163; historical input is required to rebuild. Standalone saved scene is self-contained.',
 ...
 'commands_from_project_root':[
  'blender -b -t 4 --python tools/coliseum_integration_166.py',
  'blender -b -t 4 --python tools/coliseum_integration_166.py -- render',
  'blender -b -t 2 --python tools/coliseum_delivery_audit_166.py',
  'blender -b -t 4 --python tools/coliseum_kit_proof_166.py -- coliseum-166',
  'python3 tools/publish_coliseum_166.py',
  'python3 tools/coliseum_validate_166.py',
  'python3 tools/coliseum_delivery_manifest_166.py'],
