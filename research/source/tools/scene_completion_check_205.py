...
R=Path(__file__).resolve().parents[1];O=R/'art/studies/scene-completion-205';sys.path.insert(0,str(R/'tools'));bpy.ops.wm.open_mainfile(filepath=str(O/'scene.blend'));s=bpy.context.scene
