...
from coliseum_upperwall_111 import articulate_upperwall
...
bpy.ops.wm.open_mainfile(filepath=str(O/'scene.blend'));s=bpy.context.scene;C=bpy.data.collections['110 Coliseum detailed front ruin']
(O/'upperwall-audit.json').write_text(json.dumps(articulate_upperwall(C),indent=2));apply_materials(C)
