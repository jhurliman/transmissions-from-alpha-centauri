...
R=Path(__file__).resolve().parents[1];O=R/'art/studies/ground-weathering-steps-228';base=R/'art/studies/far-building-layout-226/main-4k.png';candidate=O/'main-4k.png'
