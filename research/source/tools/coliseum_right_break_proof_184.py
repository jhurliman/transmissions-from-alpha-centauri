...
O=R/'art/studies/coliseum-184/root-proof';O.mkdir(parents=True,exist_ok=True)
cfg={
 'source':'art/studies/coliseum-173/scene.blend',
...
(R/'config/coliseum-right-break-proof-184.json').write_text(json.dumps(cfg,indent=2)+'\n')
