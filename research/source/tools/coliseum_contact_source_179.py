"""Read-only inventory of native contact strokes attached to the four crown solids."""
import bpy
import json
import sys
...
_, _, unpack = mapping()
targets = ['COL110 U4 fractured upper wall L', 'COL110 U4 aperture head',
           'COL110 U4 fractured upper wall R', 'COL110 U5 fractured upper wall L']
...
audit = {
    ...
    'limitations': ['Some unsampled segment interiors may also touch the targets.',
                   'No stroke is authorized for removal by this inventory. Compare to the actual179 retained solids, preserve supported runs, then certify any removed intervals.'],
