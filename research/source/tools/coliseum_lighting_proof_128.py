...
label=sys.argv[-1];O=R/'art/studies/coliseum-128/lighting';O.mkdir(parents=True,exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/coliseum-127/scene.blend'));start=time.time();a=apply(bpy.data.collections['110 Coliseum detailed front ruin'],label);s=bpy.context.scene
