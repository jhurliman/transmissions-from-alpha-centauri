"""Append156kit into an empty native scene; full main camera plus bay/tower/crown/flat-wall proofs."""
...
regions={'full-main-camera':(0,0,3840,2885),'bay-tower':(1630,430,2070,975),'crown':(1410,350,2350,630),'flat-wall':(1665,520,1970,800)}
...
(O/'performance.json').write_text(json.dumps({'eight_proof_render_seconds':time.time()-t,'native_frame_resolution':resolution,'regions':regions},indent=2))
