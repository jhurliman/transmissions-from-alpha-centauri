...
R=Path(__file__).resolve().parents[1];sys.path.insert(0,str(R/'tools'));from coliseum_surface_125 import apply
args=sys.argv[sys.argv.index('--')+1:];label=args[0];O=R/'art/studies/coliseum-125/surface';bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/coliseum-124/B/scene.blend'))
