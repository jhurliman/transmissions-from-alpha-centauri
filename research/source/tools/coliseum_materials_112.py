...
def masonry(role='wall'):
 m=bpy.data.materials.new('112 Painted masonry '+role);m.use_nodes=True;n=m.node_tree.nodes;l=m.node_tree.links;n.clear()
 def node(t,label=''):
 ...
 broken=ramp(flow,.465,.615);pathmask=math('MULTIPLY',paths,broken)
