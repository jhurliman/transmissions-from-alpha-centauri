...
b=signature(R/'art/reviews/xenon-052/scene.blend');results={}
for k in ['A','B','C']:
 a=signature(R/'art/reviews/xenon-053'/(k+'.blend'));assert a==b;results[k]=True
(R/'art/reviews/xenon-053/preservation-audit.json').write_text(json.dumps({'matches_052':results,'signature':b},indent=2));print('PASS all variants')
