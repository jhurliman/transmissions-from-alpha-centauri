...
def run(C):
 ...
 bpy.data.libraries.write(str(R/'art/studies/coliseum-160/right-repair/v2/candidate.blend'),{collection},fake_user=True)
 return d
if __name__=='__main__':
 bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/coliseum-156/scene.blend'));d=run(bpy.data.collections['110 Coliseum detailed front ruin']);(R/'art/studies/coliseum-160/right-repair/v2/strip-candidate-audit.json').write_text(json.dumps(d,indent=2));print(json.dumps(d),flush=True)
