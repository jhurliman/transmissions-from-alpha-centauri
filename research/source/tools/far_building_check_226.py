...
R=Path(__file__).resolve().parents[1];O=R/'art/studies/far-building-layout-226';base=R/'art/studies/alley-ground-update-225/main-4k.png';candidate=O/'main-4k.png'
