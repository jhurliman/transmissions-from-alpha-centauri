...
R=Path(__file__).resolve().parents[1];bpy.ops.wm.open_mainfile(filepath=str(R/'art/studies/coliseum-perspective-115/C/scene.blend'));s=bpy.context.scene
...
s.render.use_freestyle=False;s.render.resolution_x=1440;s.render.resolution_y=1082;s.render.filepath=str(R/'art/studies/coliseum-115/C/clay.png');bpy.ops.render.render(write_still=True)
